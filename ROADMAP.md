...
**Por que importa:** Esta é a diferença entre "YAML que gera alertas" e "governança de alertas catalog-driven". Sem isso, o pipeline de alertas está desconectado do catálogo — exatamente o problema que o OaaC se propõe a resolver.
...
**Entregáveis:**
- CLI ou gerador de template: `oaac new-service --name payments-api --tier 1 --team sre`
